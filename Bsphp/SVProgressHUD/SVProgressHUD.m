...
//        NSBundle *imageBundle = [SVProgressHUD imageBundle];
        ...
        if (@available(iOS 13.0, *)) {
            ...
            _infoImage = [self imageFromBase64String:infoBase64];
            _successImage = [self imageFromBase64String:successBase64];
            _errorImage = [self imageFromBase64String:ErrorBase64];
        }
